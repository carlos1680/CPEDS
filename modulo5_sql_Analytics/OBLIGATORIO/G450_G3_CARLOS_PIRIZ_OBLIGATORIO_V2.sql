...
a) En este caso retornaria, para todos los productos que comience con BK-, no tenga R en la cuarta posicion y no termine con un gion y dos digitos en el campo ProductNumber, el numero del producto, el nombre del producto y el total 
...
c) La clausula GROUP BY se utilizo para no traer todas las lineas de detalles de las ordenes de los productos seleccionados, sino que se quizo considerar el total de LineTotal para cada producto(de manera resumida).
*/
-- -----------------------------------------------------------------------------------------------------
/*
